...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.summary_widget.setObjectName(u"summary")
        self.summary_verticalLayout = QVBoxLayout(self.summary_widget)
        self.summary_verticalLayout.setObjectName(u"summary_verticalLayout")
        self.summary_label  = QLabel(self.summary_widget)
        self.summary_label .setObjectName(u"summary")

        self.summary_verticalLayout.addWidget(self.summary_label)
